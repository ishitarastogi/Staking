...
contract X22 is ERC20 {
    ...
    constructor() public ERC20("x22Dev", "x22d") {
...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
     using SafeERC20 for X22;

    /* ========== STATE VARIABLES ========== */

    X22 public rewardsToken;
   X22 public stakingToken;
    ...
    constructor(
        ...
        rewardsToken = X22(_rewardsToken);
        stakingToken = X22(_stakingToken);
        rewardsDistribution = _rewardsDistribution;
    }
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
       ...
       X22(tokenAddress).safeTransfer(owner, tokenAmount);
